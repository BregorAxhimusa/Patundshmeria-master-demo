    ...
    $.fn.fileuploader = function(q) {
        return this.each(function(t, r) {
            var s = $(r),
                ...
                f = {
                    init: function() { return s.closest(".fileuploader").length || s.wrap('<div class="fileuploader"></div>'), p = s.closest(".fileuploader"), f.set("attrOpts"), f.isSupported() ? (!n.beforeRender || !$.isFunction(n.beforeRender) || !1 !== n.beforeRender(p, s)) && (f.redesign(), n.files && f.files.append(n.files), f.rendered = !0, n.afterRender && $.isFunction(n.afterRender) && n.afterRender(l, p, o, s), void(f.disabled || f.bindUnbindEvents(!0))) : (n.onSupportError && $.isFunction(n.onSupportError) && n.onSupportError(p, s), !1) },
                    bindUnbindEvents: function(e) { e && f.bindUnbindEvents(!1), s[e ? "on" : "off"](f._assets.getAllEvents(), f.onEvent), n.changeInput && o !== s && o[e ? "on" : "off"]("click", f.clickHandler), n.dragDrop && n.dragDrop.container.length && (n.dragDrop.container[e ? "on" : "off"]("drag dragstart dragend dragover dragenter dragleave drop", function(e) { e.preventDefault() }), n.dragDrop.container[e ? "on" : "off"]("drop", f.dragDrop.onDrop), n.dragDrop.container[e ? "on" : "off"]("dragover", f.dragDrop.onDragEnter), n.dragDrop.container[e ? "on" : "off"]("dragleave", f.dragDrop.onDragLeave)), f.isUploadMode() && n.clipboardPaste && $(window)[e ? "on" : "off"]("paste", f.clipboard.paste), n.sorter && n.thumbnails && n.thumbnails._selectors.sorter && f.sorter[e ? "init" : "destroy"](), s.closest("form")[e ? "on" : "off"]("reset", f.reset) },
                    redesign: function() {
                    ...
                    clickHandler: function(e) { e.preventDefault(), f.clipboard._timer ? f.clipboard.clean() : s.click() },
                    onEvent: function(e) {
                        switch (e.type) {
                            case "focus":
                    ...
                    thumbnails: {
                        ...
                        renderThumbnail: function(d, e, t) {
                            function u(e) {
                                var t = $(e);
                                c.removeClass("fileuploader-no-thumbnail fileuploader-loading").html(t), d.popup && d.html.addClass("file-has-popup"), t.is("img") && t.attr("draggable", "false").on("load error", function(e) { "error" == e.type && h(!0), m(), null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) && n.thumbnails.onImageLoaded(d, l, p, o, s) }), t.is("canvas") && null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) && n.thumbnails.onImageLoaded(d, l, p, o, s)
                            }
                            var c = d.html.find(".fileuploader-item-image"),
                                i = d.data && d.data.readerSkip,
                                h = function(e) { c.addClass("fileuploader-no-thumbnail"), c.removeClass("fileuploader-loading").html(d.icon), d.popup && d.html.addClass("file-has-popup"), e && null != n.thumbnails.onImageLoaded && $.isFunction(n.thumbnails.onImageLoaded) && n.thumbnails.onImageLoaded(d, l, p, o, s) },
                                m = function() {
                                    var e = 0;
                                    if (d && -1 < f._pfrL.indexOf(d))
                                        for (f._pfrL.splice(f._pfrL.indexOf(d), 1); e < f._pfrL.length;) {
                                            if (-1 < f._itFl.indexOf(f._pfrL[e])) { setTimeout(function() { f.thumbnails.renderThumbnail(f._pfrL[e], !0) }, "image" == d.format && 1.8 < d.size / 1e6 ? 200 : 0); break }
                            ...
                            if (c.length) {
                                if (d.image = c.html("").addClass("fileuploader-loading"), (-1 < ["image", "video", "audio", "astext"].indexOf(d.format) || d.data.thumbnail) && f.isFileReaderSupported() && !i && (d.appended || n.thumbnails.startImageRenderer || e)) {
                                    if (d.html.removeClass("file-has-popup"), n.thumbnails.synchronImages && (-1 != f._pfrL.indexOf(d) || e || f._pfrL.push(d), 1 < f._pfrL.length && !e)) return;
                                    var r = function(e, t) {
                                        ...
                                        if (n.thumbnails.canvasImage) {
                                            var r = document.createElement("canvas"),
                                                a = o ? e : new Image,
                                                l = function() { f.editor.resize(this, r, n.thumbnails.canvasImage.width ? n.thumbnails.canvasImage.width : c.width(), n.thumbnails.canvasImage.height ? n.thumbnails.canvasImage.height : c.height(), !1, !0), f._assets.isBlankCanvas(r) ? h() : u(r), m() },
                                                s = function(e) { h(!0), m(), a = null };
                                    ...
                                    return "string" == typeof t || "object" == typeof t ? r(t) : f.files.read(d, function() { d.reader.node && (d.reader.frame || "img" == d.reader.node.nodeName.toLowerCase()) ? r(d.reader.frame || d.reader.src, !0) : (h("image" == d.format), m()) }, null, t, !0)
                                }
                                h()
                            } else m()
                        },
                                ...
                                var a = $(n.thumbnails.popup.container),
                                    ...
                                    e = function() {
                                        ...
                                        var e = d.popup.html || $(f._assets.textParse(n.thumbnails.popup.template, d)),
                                            i = d.popup.html !== e;
                                        u.removeClass("loading"), u.children(n.thumbnails._selectors.popup).length && ($.each(f._itFl, function(e, t) { t != d && t.popup && t.popup.close && t.popup.close(r) }), u.find(n.thumbnails._selectors.popup).remove()), e.show().appendTo(u), d.popup.html = e, d.popup.move = function(e) {
                                            var t = f._itFl.indexOf(d),
                                                o = null,
                                                i = !1;
                                            if ("prev" == (e = n.thumbnails.itemPrepend ? "prev" == e ? "next" : "prev" : e))
                                                for (var r = t; 0 <= r; r--) {
                                                    if ((a = f._itFl[r]) != d && a.popup && a.html.hasClass("file-has-popup")) { o = a; break }
                    ...
                    editor: {
                            ...
                            if (e.reader.node) {
                                ...
                                e.popup.editor.cropper && e.popup.editor.cropper.$template.hide(), e.popup.editor.rotation = o ? t : i + 90, e.popup.editor.scale = (r.height() / p[-1 < [90, 270].indexOf(e.popup.editor.rotation) ? "width" : "height"]()).toFixed(3), p.height() * e.popup.editor.scale > r.width() && -1 < [90, 270].indexOf(e.popup.editor.rotation) && (e.popup.editor.scale = r.height() / p.width()), 1 < e.popup.editor.scale && (e.popup.editor.scale = 1), $(a).stop().animate({ rotation: e.popup.editor.rotation, scale: e.popup.editor.scale }, {
                                    ...
                                    step: function(e, t) {
                                        ...
                                        p.css({ "-webkit-transform": "rotate(" + i + "deg) scale(" + n + ")", "-moz-transform": "rotate(" + i + "deg) scale(" + n + ")", transform: "rotate(" + i + "deg) scale(" + n + ")" })
                                    },
                                    always: function() { delete e.popup.editor.isAnimating, e.popup.editor.cropper && !o && (e.popup.editor.cropper.setDefaultData(), e.popup.editor.cropper.init("rotation")) }
                        ...
                        crop: function(b, e) {
                            ...
                            if (b.reader.node)
                                if (b.popup.editor.cropper) e && (b.popup.editor.cropper.crop = e), b.popup.editor.cropper.init(e);
                                else {
                                    ...
                                    b.popup.editor.cropper = {
                                        ...
                                        init: function(o) {
                                            ...
                                            i.isCropping || (i.$imageEl.clone().appendTo(i.$template.find(".area-image")), i.$imageEl.parent().append(l)), i.$template.hide().css({ left: e.left, top: e.top, width: t, height: r }).fadeIn(150), i.$editor.hide(), clearTimeout(i._editorAnimationTimeout), i._editorAnimationTimeout = setTimeout(function() {
                                        ...
                                        setDefaultData: function() {
                                            var e = b.popup.editor.cropper,
                                                ...
                                                o = t.width(),
                                                i = t.height(),
                                                n = b.popup.editor.rotation && -1 < [90, 270].indexOf(b.popup.editor.rotation),
                                                r = b.popup.editor.scale || 1;
                                            return e.crop = { left: 0, top: 0, width: n ? i * r : o, height: n ? o * r : i, cfWidth: o / b.reader.width, cfHeight: i / b.reader.height }, null
                                        },
                                        hide: function(e) {
                                        ...
                                        drawPlaceHolder: function(e) {
                                            var t = b.popup.editor.cropper,
                                                ...
                                                n = [0, 0];
                                            e && (e = $.extend({}, e), o && (n = [180 == o || 270 == o ? -100 : 0, 90 == o || 180 == o ? -100 : 0]), t.$editor.css(e), t.setAreaInfo(), t.$editor.find(".area-image img").removeAttr("style").css({ width: t.$imageEl.width(), height: t.$imageEl.height(), left: -1 * t.$editor.position().left, top: -1 * t.$editor.position().top, "-webkit-transform": "rotate(" + o + "deg) scale(" + i + ") translateX(" + n[0] + "%) translateY(" + n[1] + "%)", "-moz-transform": "rotate(" + o + "deg) scale(" + i + ") translateX(" + n[0] + "%) translateY(" + n[1] + "%)", transform: "rotate(" + o + "deg) scale(" + i + ") translateX(" + n[0] + "%) translateY(" + n[1] + "%)" }))
                                        },
                                        ...
                                        mousedown: function(e) {
                                            function t() { r.pointData = { el: i, x: a.x, y: a.y, xEditor: a.x - r.crop.left, yEditor: a.y - r.crop.top, left: r.crop.left, top: r.crop.top, width: r.crop.width, height: r.crop.height }, (r.isMoving || r.isResizing) && (r.setAreaInfo("size"), r.$editor.addClass("moving show-info"), $("body").css({ "-webkit-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "user-select": "none" }), $(document).on("mousemove touchmove", r.mousemove)) }
                                            var o = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                                i = $(e.target),
                                                r = b.popup.editor.cropper,
                                                a = { x: ("mousedown" == o ? e.pageX : e.originalEvent.touches[0].pageX) - r.$template.offset().left, y: ("mousedown" == o ? e.pageY : e.originalEvent.touches[0].pageY) - r.$template.offset().top };
                                            b.popup.zoomer && b.popup.zoomer.hasSpacePressed || (r.isMoving = i.is(".area-move"), r.isResizing = i.is(".point"), "mousedown" == o && t(), "touchstart" == o && 1 == e.originalEvent.touches.length && ((r.isMoving || r.isResizing) && e.preventDefault(), r.isTouchLongPress = !0, setTimeout(function() { r.isTouchLongPress && (delete r.isTouchLongPress, t()) }, n.thumbnails.touchDelay ? n.thumbnails.touchDelay : 0)), $(document).on("mouseup touchend", r.mouseup))
                                        },
                                        mousemove: function(e) {
                                            var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                                o = ($(e.target), b.popup.editor.cropper),
                                                i = { x: ("mousedown" == t ? e.pageX : e.originalEvent.touches[0].pageX) - o.$template.offset().left, y: ("mousedown" == t ? e.pageY : e.originalEvent.touches[0].pageY) - o.$template.offset().top };
                                        ...
                                        mouseup: function(e) {
                                            var t = b.popup.editor.cropper;
                                            0 != t.$editor.width() && 0 != t.$editor.height() || t.init(t.setDefaultData()), delete t.isTouchLongPress, delete t.isMoving, delete t.isResizing, t.$editor.removeClass("moving show-info"), $("body").css({ "-webkit-user-select": "", "-moz-user-select": "", "-ms-user-select": "", "user-select": "" }), $(document).off("mousemove touchmove", t.mousemove), $(document).off("mouseup touchend", t.mouseup)
                                        }
                            ...
                            if (s.popup && s.popup.html && $("html").find(s.popup.html).length) {
                                if (!s.popup.zoomer) {
                                    ...
                                    s.popup.zoomer = {
                                        ...
                                        mousedown: function(e) {
                                            function t() { o.pointData = { x: a.x, y: a.y, xTarget: a.x - o.left, yTarget: a.y - o.top }, $("body").css({ "-webkit-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "user-select": "none" }), p.addClass("is-moving"), $(document).on("mousemove", o.mousemove) }
                                            ...
                                            1 == e.which && 100 != o.scale && o.zoom != o.scale && (o.hasSpacePressed || i[0] == d[0] || i.is(".fileuploader-cropper")) && ("mousedown" == r && t(), "touchstart" == r && (o.isTouchLongPress = !0, setTimeout(function() { o.isTouchLongPress && (delete o.isTouchLongPress, t()) }, n.thumbnails.touchDelay ? n.thumbnails.touchDelay : 0)), $(document).on("mouseup touchend", o.mouseup))
                                        },
                                        mousemove: function(e) {
                                            var t = s.popup.zoomer,
                                            ...
                                            0 < a && (a = 0), a < l.height() - p.height() && (a = l.height() - p.height()), p.height() < l.height() && (a = l.height() / 2 - p.height() / 2), p.width() > l.width() ? (0 < r && (r = 0), r < l.width() - p.width() && (r = l.width() - p.width())) : r = l.width() / 2 - p.width() / 2, p.css({ left: (t.left = r) + "px", top: (t.top = a) + "px" })
                                        },
                                        mouseup: function(e) {
                                            var t = s.popup.zoomer;
                                            delete t.pointData, $("body").css({ "-webkit-user-select": "", "-moz-user-select": "", "-ms-user-select": "", "user-select": "" }), p.removeClass("is-moving"), $(document).off("mousemove", t.mousemove), $(document).off("mouseup", t.mouseup)
                                        },
                                        zoomIn: function(e) {
                                            var t = s.popup.zoomer,
                                                o = e || 20;
                                        ...
                                        updateView: function(e, t) {
                                            ...
                                            l ? p.addClass("is-movable").css({ width: i + "px", height: n + "px", maxWidth: "none", maxHeight: "none" }) : p.removeClass("is-movable is-amoving").removeAttr("style"), o.zoom = e || o.scale, o.center(l ? [r, a, o.left, o.top] : null), o.html.find("span").html(o.zoom + "%"), t || o.html.find("input").val(o.zoom), e && s.popup.editor && s.popup.editor.cropper && s.popup.editor.cropper.resize(!0)
                                        },
                                        isZoomed: function() { return this.zoom > this.scale },
                                        getImageSize: function() { return { width: d.prop("naturalWidth"), height: d.prop("naturalHeight") } },
                                        getImageScale: function() { return Math.round(100 / (d.prop("naturalWidth") / d.width())) }
                                    }
                                }
                                s.popup.zoomer.init()
                            }
                        ...
                        save: function(w, b, x, y, _) {
                                ...
                                if (w.reader.node) {
                                    ...
                                    var c = x || w.type || "image/jpeg",
                                        ...
                                        g = function(e, t) {
                                            ...
                                            _ || f.thumbnails.renderThumbnail(w, !0, t || e), y && y(i, w, l, p, o, s), null != n.editor.onSave && "function" == typeof n.editor.onSave && n.editor.onSave(i, w, l, p, o, s), f.set("listInput", null)
                                        };
                            ...
                            f._assets.isMobile() ? (i.onload = e, i.src = w.reader.src) : w.reader.node ? e.call(w.reader.node) : w.reader.read(function() { e.call(w.reader.node) })
                        }
                    },
                    sorter: {
                        init: function() { p.on("mousedown touchstart", n.thumbnails._selectors.sorter, f.sorter.mousedown) },
                        destroy: function() { p.off("mousedown touchstart", n.thumbnails._selectors.sorter, f.sorter.mousedown) },
                        findItemAtPos: function(i) {
                            var e = f.sorter.sort,
                                t = e.items.not(e.item.html),
                                n = null;
                            return t.each(function(e, t) { var o = $(t); if (i.x > o.offset().left && i.x < o.offset().left + o.outerWidth() && i.y > o.offset().top && i.y < o.offset().top + o.outerHeight()) return n = o, !1 }), n
                        },
                        mousedown: function(e) {
                            function t() { f.sorter.sort = { el: i, item: a, items: l.find(n.thumbnails._selectors.item), x: s.x, y: s.y, xItem: s.x - r.offset().left, yItem: s.y - r.offset().top, left: r.position().left, top: r.position().top, width: r.outerWidth(), height: r.outerHeight(), placeholder: n.sorter.placeholder ? $(n.sorter.placeholder) : a.html.clone().addClass("fileuploader-sorter-placeholder").html("") }, $("body").css({ "-webkit-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "user-select": "none" }), $(document).on("mousemove touchmove", f.sorter.mousemove) }
                            var o = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                i = $(e.target),
                            ...
                            e.preventDefault(), f.sorter.sort && f.sorter.mouseup(), a && (n.sorter.selectorExclude && (i.is(n.sorter.selectorExclude) || i.closest(n.sorter.selectorExclude).length) || ($(n.thumbnails._selectors.sorter).on("click drop dragend dragleave dragover dragenter dragstart touchstart touchmove touchend touchcancel", function(e) { e.preventDefault() }), "mousedown" == o && t(), "touchstart" == o && (f.sorter.isTouchLongPress = !0, setTimeout(function() { f.sorter.isTouchLongPress && (delete f.sorter.isTouchLongPress, t()) }, n.thumbnails.touchDelay ? n.thumbnails.touchDelay : 0)), $(document).on("mouseup touchend", f.sorter.mouseup)))
                        },
                        mousemove: function(e) {
                            var t = e.originalEvent.touches && e.originalEvent.touches[0] ? "touchstart" : "mousedown",
                                o = f.sorter.sort,
                            ...
                            h + o.xItem > a.width() && (h = a.width() - o.xItem), h + o.xItem < 0 && (h = 0 - o.xItem), m + o.yItem > a.height() && (m = a.height() - o.yItem), m + o.yItem < 0 && (m = 0 - o.yItem), v <= 0 && a.scrollTop(u - 10), v > a.height() && a.scrollTop(u + 10), g < 0 && a.scrollLeft(d - 10), g > a.width() && a.scrollLeft(d + 10), i.html.addClass("sorting").css({ position: "fixed", left: h, top: m, width: f.sorter.sort.width, height: f.sorter.sort.height }), l.find(o.placeholder).length || i.html.after(o.placeholder), o.placeholder.css({ width: f.sorter.sort.width, height: f.sorter.sort.height });
                            ...
                            if (w) {
                                ...
                                if (f.sorter.sort.lastHover && f.sorter.sort.lastHover.el == w[0]) { if (x && "before" == f.sorter.sort.lastHover.direction && c.y < f.sorter.sort.lastHover.y) return; if (x && "after" == f.sorter.sort.lastHover.direction && c.y > f.sorter.sort.lastHover.y) return; if (b && "before" == f.sorter.sort.lastHover.direction && c.x < f.sorter.sort.lastHover.x) return; if (b && "after" == f.sorter.sort.lastHover.direction && c.x > f.sorter.sort.lastHover.x) return }
                                var y = r.index(i.html),
                                    _ = r.index(w) < y ? "before" : "after";
                                w[_](o.placeholder), w[_](i.html), f.sorter.sort.lastHover = { el: w[0], x: c.x, y: c.y, direction: _ }
                            }
                        },
                        mouseup: function() {
                            var e = f.sorter.sort,
                                t = e.item;
                            $("body").css({ "-webkit-user-select": "", "-moz-user-select": "", "-ms-user-select": "", "user-select": "" }), t.html.removeClass("sorting").css({ position: "", left: "", top: "", width: "", height: "" }), $(document).off("mousemove touchmove", f.sorter.mousemove), $(document).off("mouseup touchend", f.sorter.mouseup), e.placeholder.remove(), delete f.sorter.sort, f.sorter.save()
                        },
                        save: function(e) {
                            var i, r = 0,
                                a = [],
                    ...
                    upload: {
                        prepare: function(t, e) { t.upload = { url: n.upload.url, data: $.extend({}, n.upload.data), formData: new FormData, type: n.upload.type || "POST", enctype: n.upload.enctype || "multipart/form-data", cache: !1, contentType: !1, processData: !1, chunk: t.upload ? t.upload.chunk : null, status: null, send: function() { f.upload.send(t, !0) }, cancel: function(e) { f.upload.cancel(t, e) } }, t.upload.formData.append(s.attr("name"), t.file, !!t.name && t.name), (n.upload.start || e) && f.upload.send(t, e) },
                        send: function(a, e) {
                            if (a.upload) {
                                var d = function(e) { a.html && a.html.removeClass("upload-pending upload-loading upload-cancelled upload-failed upload-success").addClass("upload-" + (e || a.upload.status)) },
                                    r = function() {
                                        var e = 0;
                                        if (0 < f._pfuL.length)
                                            for (-1 < f._pfuL.indexOf(a) && f._pfuL.splice(f._pfuL.indexOf(a), 1); e < f._pfuL.length;) {
                                                if (-1 < f._itFl.indexOf(f._pfuL[e]) && f._pfuL[e].upload && !f._pfuL[e].upload.$ajax) { f.upload.send(f._pfuL[e], !0); break }
                                ...
                                if (n.upload.chunk && a.file.slice) {
                                    ...
                                    if (1 < i && !a.upload.chunk && (a.upload.chunk = { name: a.name, size: a.file.size, type: a.file.type, chunkSize: t, temp_name: a.name, loaded: 0, total: i, i: -1 }), a.upload.chunk)
                                ...
                                a.upload.data = a.upload.formData, a.upload.xhr = function() {
                                    ...
                                    return e.upload && e.upload.addEventListener("progress", function(e) { a.upload.$ajax && (a.upload.$ajax.total = a.upload.chunk ? a.upload.chunk.size : e.total, a.upload.$ajax.xhrStartedAt = t), f.upload.progressHandling(e, a, t) }, !1), e
                                }, a.upload.complete = function(e, t) {
                                    if (a.upload.chunk && !a.upload.chunk.isLast && "success" == t) return f.upload.send(a);
                                    r();
                                    var i = !0;
                                    $.each(f._itFl, function(e, t) { t.upload && t.upload.$ajax && (i = !1) }), i && (p.removeClass("fileuploader-is-uploading"), null != n.upload.onComplete && "function" == typeof n.upload.onComplete && n.upload.onComplete(l, p, o, s, e, t))
                                }, a.upload.success = function(e, t, i) {
                                    if (!a.upload.chunk || a.upload.chunk.isLast) delete a.upload.chunk, f.upload.progressHandling(null, a, a.upload.$ajax.xhrStartedAt, !0), a.uploaded = !0, delete a.upload, a.upload = { status: "successful", resend: function() { f.upload.retry(a) } }, a.html && d(), null != n.upload.onSuccess && $.isFunction(n.upload.onSuccess) && n.upload.onSuccess(e, a, l, p, o, s, t, i), f.set("listInput", null);
                                    else try {
                                        var r = JSON.parse(e);
                                        a.upload.chunk.temp_name = r.fileuploader.temp_name
                                    } catch (e) {}
                                }, a.upload.error = function(e, t, i) { a.upload.chunk && (a.upload.chunk.i = Math.max(-1, a.upload.chunk.i - 1)), a.uploaded = !1, a.upload.status = "cancelled" == a.upload.status ? a.upload.status : "failed", a.upload.retry = function() { f.upload.retry(a) }, delete a.upload.$ajax, a.html && d(), null != n.upload.onError && $.isFunction(n.upload.onError) && n.upload.onError(a, l, p, o, s, e, t, i) }, a.upload.$ajax = $.ajax(a.upload)
                            }
                        },
                        cancel: function(e, t) { e && e.upload && (e.upload.status = "cancelled", delete e.upload.chunk, e.upload.$ajax && e.upload.$ajax.abort(), delete e.upload.$ajax, t || f.files.remove(e)) },
                        retry: function(e) { e && e.upload && (e.html && n.thumbnails._selectors.retry && e.html.find(n.thumbnails._selectors.retry).remove(), f.upload.prepare(e, !0)) },
                        progressHandling: function(e, t, i, r) {
                            if (!e && r && t.upload.$ajax && (e = { total: t.upload.$ajax.total, loaded: t.upload.$ajax.total, lengthComputable: !0 }), e.lengthComputable) {
                                var a = e.loaded + (t.upload.chunk ? t.upload.chunk.loaded : 0),
                                    ...
                                    w = { loaded: a, loadedInFormat: f._assets.bytesToText(a), total: d, totalInFormat: f._assets.bytesToText(d), percentage: u, secondsElapsed: h, secondsElapsedInFormat: f._assets.secondsToText(h, !0), bytesPerSecond: m, bytesPerSecondInFormat: f._assets.bytesToText(m) + "/s", remainingBytes: g, remainingBytesInFormat: f._assets.bytesToText(g), secondsRemaining: v, secondsRemainingInFormat: f._assets.secondsToText(v, !0) };
                    ...
                    dragDrop: {
                        onDragEnter: function(e) { clearTimeout(f.dragDrop._timer), n.dragDrop.container.addClass("fileuploader-dragging"), f.set("feedback", f._assets.textParse(n.captions.drop)), null != n.dragDrop.onDragEnter && $.isFunction(n.dragDrop.onDragEnter) && n.dragDrop.onDragEnter(e, l, p, o, s) },
                            ...
                            if (f._assets.isIntoView(o) && e.originalEvent.clipboardData && e.originalEvent.clipboardData.items && e.originalEvent.clipboardData.items.length) {
                                ...
                                for (var i = 0; i < t.length; i++)
                                    if (-1 !== t[i].type.indexOf("image") || -1 !== t[i].type.indexOf("text/uri-list")) {
                                        ...
                                        r && (r._name = f._assets.generateFileName(-1 != r.type.indexOf("/") ? r.type.split("/")[1].toString().toLowerCase() : "png", "Clipboard "), f.set("feedback", f._assets.textParse(n.captions.paste, { ms: a / 1e3 })), f.clipboard._timer = setTimeout(function() { f.set("feedback", null), f.onChange(e, [r]) }, a - 2))
                                    }
                            }
                        },
                        clean: function() { f.clipboard._timer && (clearTimeout(f.clipboard._timer), delete f.clipboard._timer, f.set("feedback", null)) }
                    },
                    files: {
                        add: function(e, t) {
                            var o, r, i = e._name || e.name,
                                ...
                                h = { name: i, title: c, size: a, size2: l, type: p, format: d, extension: u, data: h = e.data || {}, file: e.file || e, reader: { read: function(e, t, o) { return f.files.read(r, e, t, o) } }, id: "updated" == t ? e.id : Date.now(), input: "choosed" == t ? s : null, html: null, choosed: "choosed" == t, appended: "appended" == t || "updated" == t, uploaded: "uploaded" == t };
                            return "updated" != t ? (f._itFl.push(h), o = f._itFl.length - 1, r = f._itFl[o]) : (o = f._itFl.indexOf(e), f._itFl[o] = r = h), r.remove = function() { f.files.remove(r) }, n.editor && "image" == d && (r.editor = { rotate: function(e) { f.editor.rotate(r, e) }, cropper: function(e) { f.editor.crop(r, e) }, save: function(e, t, o, i) { f.editor.save(r, t, o, e, i) } }), e.local && (r.local = e.local), o
                        },
                        read: function(d, e, t, i, r) {
                            if (f.isFileReaderSupported() && !d.data.readerSkip) {
                                ...
                                }, a.onerror = function() { m(), d.reader = { read: d.reader.read } }, h ? a.readAsText(d.file) : $.ajax({ url: d.file, success: function(e) { a.onload({ target: { result: e } }) }, error: function() { a.onerror() } });
                                                ...
                                                d.data && d.data.readerCrossOrigin && s.setAttribute("crossOrigin", d.data.readerCrossOrigin), s.src = e.target.result + (!d.data.readerForce && !i || h || c || -1 != e.target.result.indexOf("data:image") ? "" : (-1 == e.target.result.indexOf("?") ? "?" : "&") + "d=" + Date.now()), s.onload = function() {
                                                    if (d.reader.exifOrientation) {
                                                        var e = document.createElement("canvas"),
                                                            ...
                                                            n = [0, 180];
                                                        e.width = o.naturalWidth, e.height = o.naturalHeight, t.drawImage(o, 0, 0), e.width = -1 < n.indexOf(i) ? o.naturalWidth : o.naturalHeight, e.height = -1 < n.indexOf(i) ? o.naturalHeight : o.naturalWidth;
                                                        var r = i * Math.PI / 180,
                                                            a = .5 * e.width,
                                                            l = .5 * e.height;
                                                        return t.clearRect(0, 0, e.width, e.height), t.translate(a, l), t.rotate(r), t.translate(.5 * -o.naturalWidth, .5 * -o.naturalHeight), t.drawImage(o, 0, 0), t.setTransform(1, 0, 0, 1, 0, 0), s.src = e.toDataURL(d.type, 1), void delete d.reader.exifOrientation
                                                    }
                                                    d.reader.node = s, d.reader.src = s.src, d.reader.width = s.width, d.reader.height = s.height, d.reader.ratio = f._assets.pxToRatio(d.reader.width, d.reader.height), w && u.revokeObjectURL(w), m(), c && (d.reader = { read: d.reader.read })
                                                }, s.onerror = function() { m(), d.reader = { read: d.reader.read } }
                                            }
                                            var s = new Image;
                                            n.thumbnails.exif && d.choosed ? f._assets.getExifOrientation(d.file, function(e) { e && (d.reader.exifOrientation = e), t() }) : t()
                                        }, a.onerror = function() { m(), d.reader = { read: d.reader.read } }, !c && d.size > f._assets.toBytes(n.reader.maxSize)) return a.onerror();
                                    h ? n.thumbnails.useObjectUrl && n.thumbnails.canvasImage && u ? a.onload({ target: { result: w = u.createObjectURL(d.file) } }) : a.readAsDataURL(d.file) : a.onload({ target: { result: c ? d.data.thumbnail : d.file } })
                                } else if ("video" == d.format || "audio" == d.format) {
                                    var g = (v = document.createElement(d.format)).canPlayType(d.type);
                                    if (a.onerror = function() { d.reader.node = null, m(), d.reader = { read: d.reader.read } }, u && "" !== g) {
                                        if (r && !n.thumbnails.videoThumbnail) return d.reader.node = v, m(), void(d.reader = { read: d.reader.read });
                                        w = h ? u.createObjectURL(d.file) : d.file, v.onloadedmetadata = function() { d.reader.node = v, d.reader.src = v.src, d.reader.duration = v.duration, d.reader.duration2 = f._assets.secondsToText(v.duration), "video" == d.format && (d.reader.width = v.videoWidth, d.reader.height = v.videoHeight, d.reader.ratio = f._assets.pxToRatio(d.reader.width, d.reader.height)) }, v.onerror = function() { m(), d.reader = { read: d.reader.read } }, v.onloadeddata = function() {
                                            if ("video" == d.format) {
                                                var e = document.createElement("canvas"),
                                                    t = e.getContext("2d");
                                            ...
                                            m()
                                        }, setTimeout(function() { d.data && d.data.readerCrossOrigin && v.setAttribute("crossOrigin", d.data.readerCrossOrigin), v.src = w + "#t=1" }, 100)
                                    } else a.onerror()
                                } else if ("application/pdf" == d.type && n.thumbnails.pdf) {
                                    var v = document.createElement("iframe"),
                                        w = h ? u.createObjectURL(d.file) : (n.thumbnails.pdf.urlPrefix || "") + d.file;
                                    n.thumbnails.pdf.viewer || f._assets.hasPlugin("pdf") ? (v.onload = function() { d.reader.node = v, d.reader.src = v.src, v.style.display = "", m() }, v.src = (n.thumbnails.pdf.viewer || "") + w, v.style.display = "none", document.body.appendChild(v)) : m()
                                } else a.onload = function(e) { d.reader.src = e.target.result, d.reader.length = e.target.result.length, m() }, a.onerror = function(e) { m(), d.reader = { read: d.reader.read } }, h ? a[t || "readAsBinaryString"](d.file) : m();
                        ...
                        find: function(o) { var i = null; return $.each(f._itFl, function(e, t) { if (t.html && t.html.is(o)) return i = t, !1 }), i },
                        remove: function(i, r) {
                            if (r || !n.onRemove || !$.isFunction(n.onRemove) || !1 !== n.onRemove(i, l, p, o, s)) {
                                if (i.html && (n.thumbnails.onItemRemove && $.isFunction(n.thumbnails.onItemRemove) && !r ? n.thumbnails.onItemRemove(i.html, l, p, o, s) : i.html.remove()), i.upload && i.upload.$ajax && i.upload.cancel && i.upload.cancel(!0), i.popup && i.popup.close && i.popup.close(), i.reader.src && (i.reader.node = null, URL.revokeObjectURL(i.reader.src)), i.input) {
                                    var a = !0;
                                    $.each(f._itFl, function(e, t) { if (i != t && (i.input == t.input || r && 1 < i.input.get(0).files.length)) return a = !1 }), a && (f.isAddMoreMode() && 1 < sl.length ? (f.set("nextInput"), sl.splice(sl.indexOf(i.input), 1), i.input.remove()) : f.set("input", ""))
                        ...
                        getItemAttr: function(e, t) { var o = null; return e && (void 0 !== e[t] ? o = e[t] : e.data && void 0 !== e.data[t] && (o = e.data[t])), o },
                        clear: function(e) {
                    ...
                    reset: function(e) { e && (f.clipboard._timer && f.clipboard.clean(), $.each(sl, function(e, t) { e < sl.length && t.remove() }), sl = [], f.set("input", "")), f._itRl = [], f._pfuL = [], f._pfrL = [], f.files.clear(e) },
                    destroy: function() { f.reset(!0), f.bindUnbindEvents(!1), s.removeAttr("style"), p.before(s), delete s.get(0).FileUploader, p.remove(), p = o = l = null },
                    _assets: {
                        toBytes: function(e) { return 1048576 * parseInt(e) },
                        bytesToText: function(e) { if (0 == e) return "0 Byte"; var t = Math.floor(Math.log(e) / Math.log(1024)); return (e / Math.pow(1024, t)).toPrecision(3) + " " + ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"][t] },
                        escape: function(e) { return ("" + e).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;") },
                        ...
                        pxToRatio: function(e, t) {
                            var o = function(e, t) { return 0 == t ? e : o(t, e % t) },
                                i = o(e, t);
                            return [e / i, t / i]
                        },
                        ratioToPx: function(e, t, o) { return (o = (o + "").split(":")).length < 2 ? null : [t / o[1] * o[0], e / o[0] * o[1], o[0], o[1]] },
                        hasAttr: function(e, t) { var o = (t = t || s).attr(e); return !(!o || void 0 === o) },
                        copyAllAttributes: function(e, t) { return $.each(t.get(0).attributes, function() { "required" != this.name && "type" != this.name && e.attr(this.name, this.value) }), t.get(0).FileUploader && (e.get(0).FileUploader = t.get(0).FileUploader), e },
                        getAllEvents: function(e) { e = e || s; var t = []; for (var o in e = e.get ? e.get(0) : e) 0 === o.indexOf("on") && t.push(o.slice(2)); return -1 == t.indexOf("change") && t.push("change"), t.join(" ") },
                        ...
                        isBlankCanvas: function(e) {
                            ...
                            try { o = e.toDataURL() == t.toDataURL() } catch (e) {}
                            return t = null, o
                        },
                        generateFileName: function(e, t) {
                            function o(e) { return e < 10 && (e = "0" + e), e }
                            var i = new Date;
                            e = e ? "." + e : "";
                            return (t = t || "") + i.getFullYear() + "-" + o(i.getMonth() + 1) + "-" + o(i.getDate()) + " " + o(i.getHours()) + "-" + o(i.getMinutes()) + "-" + o(i.getSeconds()) + e
                        },
                        arrayBufferToBase64: function(e) { for (var t = "", o = new Uint8Array(e), i = 0; i < o.byteLength; i++) t += String.fromCharCode(o[i]); return window.btoa(t) },
                        dataURItoBlob: function(e, t) { for (var o = atob(e.split(",")[1]), i = e.split(",")[0].split(":")[1].split(";")[0], n = new ArrayBuffer(o.length), r = new Uint8Array(n), a = 0; a < o.length; a++) r[a] = o.charCodeAt(a); var l = new DataView(n); return new Blob([l.buffer], { type: t || i }) },
                        getExifOrientation: function(e, p) {
                            ...
                            t.onload = function(e) {
                                ...
                                if (t.byteLength && 65496 == t.getUint16(0, !1))
                                    for (var i = t.byteLength, n = 2; n < i && !(t.getUint16(n + 2, !1) <= 8);) {
                                        ...
                                        if (n += 2, 65505 == r) {
                                            ...
                                            for (var s = 0; s < a; s++)
                                                if (274 == t.getUint16(n + 12 * s, l)) { o = t.getUint16(n + 12 * s + 8, l), i = 0; break }
                                        } else {
                                ...
                                p && p(d[o] || 0)
                            }, t.onerror = function() { p && p("") }, t.readAsArrayBuffer(e)
                        },
                                ...
                                case "string":
                                    ...
                                    text = text.replace(/\$\{(.*?)\}/g, function(match, a) {
                                        ...
                                        if (-1 < a.indexOf(".") || -1 < a.indexOf("[]")) {
                                            ...
                                            if (opts[x]) try { r = eval('opts["' + x + '"]' + y) } catch (e) { r = "" }
                                        }
                        ...
                        isIE: function() { return -1 < navigator.userAgent.indexOf("MSIE ") || -1 < navigator.userAgent.indexOf("Trident/") || -1 < navigator.userAgent.indexOf("Edge") },
                        isMobile: function() { return void 0 !== window.orientation || -1 !== navigator.userAgent.indexOf("IEMobile") }
                    },
                    ...
                    isDefaultMode: function() { return !(n.upload || n.addMore && 1 != n.limit) },
                    isAddMoreMode: function() { return !n.upload && n.addMore && 1 != n.limit },
            ...
            return n.enableApi && (s.get(0).FileUploader = {
                ...
                getChoosedFiles: function() { return f._itFl.filter(function(e) { return e.choosed }) },
                getAppendedFiles: function() { return f._itFl.filter(function(e) { return e.appended }) },
                getUploadedFiles: function() { return f._itFl.filter(function(e) { return e.uploaded }) },
                getFileList: function(e, t) { return f.files.list(e, t, !0) },
                updateFileList: function() { return f.set("listInput", null), !0 },
                setOption: function(e, t) { return n[e] = t, !0 },
                findFile: function(e) { return f.files.find(e) },
                add: function(e, t, o) {
                ...
                append: function(e) { return f.files.append(e) },
                update: function(e, t) { return f.files.update(e, t) },
                remove: function(e) { return e = e.jquery ? f.files.find(e) : e, -1 < f._itFl.indexOf(e) && (f.files.remove(e), !0) },
                uploadStart: function() {
                    var e = this.getChoosedFiles() || [];
                    if (f.isUploadMode() && 0 < e.length && !e[0].uploaded)
                        for (var t = 0; t < e.length; t++) f.upload.send(e[t])
                },
                reset: function() { return f.reset(!0), !0 },
                disable: function(e) { return f.set("disabled", !0), e && (f.locked = !0), !0 },
                enable: function() { return f.set("disabled", !1), !(f.locked = !1) },
